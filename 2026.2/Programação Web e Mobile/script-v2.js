...
// ============================================================
// MODIFICADO: SEÇÃO ADICIONADA - Ligação dos eventos dos botões
// ------------------------------------------------------------
// Antes, cada botão tinha um atributo onclick="funcao()" direto
// no HTML (JavaScript inline). Isso foi removido do HTML e,
// em seu lugar, cada botão passou a ter apenas um "id".
// Aqui usamos addEventListener para ligar cada botão à sua
// função, mantendo o HTML 100% livre de JavaScript.
//
// Boa prática: esperamos o DOM carregar (DOMContentLoaded)
// antes de buscar os elementos e registrar os eventos.
// ============================================================
document.addEventListener('DOMContentLoaded', () => {
// Seção 1: if/else
document.getElementById('btn-verificar-idade').addEventListener('click', verificarIdade);
document.getElementById('btn-classificar-nota').addEventListener('click', classificarNota);

// Seção 2: ternário e switch
document.getElementById('btn-testar-ternario').addEventListener('click', testarTernario);
document.getElementById('btn-verificar-dia').addEventListener('click', verificarDia);

// Seção 3: for
document.getElementById('btn-gerar-tabuada').addEventListener('click', gerarTabuada);
document.getElementById('btn-contagem-regressiva').addEventListener('click', contagemRegressiva);

// Seção 4: while
document.getElementById('btn-soma-ate-n').addEventListener('click', somaAteN);

// Seção 5: funções
document.getElementById('btn-somar').addEventListener('click', usarSomar);
document.getElementById('btn-subtrair').addEventListener('click', usarSubtrair);
document.getElementById('btn-multiplicar').addEventListener('click', usarMultiplicar);
document.getElementById('btn-dividir').addEventListener('click', usarDividir);
document.getElementById('btn-calcular-dobro').addEventListener('click', calcularDobro);

// Seção 6: exercícios
document.getElementById('btn-fizzbuzz').addEventListener('click', fizzBuzz);
document.getElementById('btn-mostrar-pares').addEventListener('click', mostrarPares);
document.getElementById('btn-calcular-fatorial').addEventListener('click', calcularFatorial);
document.getElementById('btn-verificar-primo').addEventListener('click', verificarPrimo);
});